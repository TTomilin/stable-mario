...
class RecurrentRolloutBuffer(RolloutBuffer):
    ...
    def reset(self) -> None:
        self.hidden_states = np.zeros((self.buffer_size, self.n_envs, *self.obs_shape), dtype=np.float32)
        super().reset()
    ...
    def add(
        ...
        self.hidden_states[self.pos] = np.array(hidden_state)
        super(obs, action, reward, episode_start, value, log_prob)
