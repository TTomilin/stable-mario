...
class CustomFrameStack(gym.ObservationWrapper, gym.utils.RecordConstructorArgs):
    def __init__(
        ...
        gym.utils.RecordConstructorArgs.__init__(
            self, num_stack=stack_depth, lz4_compress=False
        )
        gym.ObservationWrapper.__init__(self, env)
        ...
        low = np.tile(self.observation_space.low, (self.stack_depth, 1, 1))
        high = np.tile(self.observation_space.high, (self.stack_depth, 1, 1))
