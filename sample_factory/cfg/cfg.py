...
def add_mario_args(p: ArgumentParser):
    ...
    p.add_argument("--stack_frames_test", default=0, type=int, help="Stack frames wrapper. Stacks the last n frames")
...
def add_logging_args(p: ArgumentParser):
    ...
    p.add_argument("--wandb_project", default="Mario", type=str, help='WandB "Project"')
    p.add_argument(
        "--wandb_group",
        default=None,
        type=str,
    ...
    p.add_argument("--wandb_job_type", default="PPO", type=str, help="WandB job type")
    p.add_argument(
        "--wandb_tags",
        default=[],
        type=str,
